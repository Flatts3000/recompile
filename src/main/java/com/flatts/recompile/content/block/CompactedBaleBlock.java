...
/**
 * Compacted bale (design P1.1): dense mixed trash, roughly 1.4x a garbage block's
 ...
 * Sorting Tarp, and the block where hauling to the tarp pays off most: ~3.5 pulls
 * by knife against the tarp's 8. See {@link SortableBlock}.
 */
