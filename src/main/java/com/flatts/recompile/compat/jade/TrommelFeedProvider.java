...
/**
 * Jade: how to put something INTO a Trommel.
 *
 ...
 */
public enum TrommelFeedProvider implements IBlockComponentProvider {
    INSTANCE;

    private static final Identifier UID =
        Identifier.fromNamespaceAndPath(Recompile.MOD_ID, "trommel_feed");

    @Override
    public void appendTooltip(ITooltip tooltip, BlockAccessor accessor, IPluginConfig config) {
        if (accessor.getBlock() instanceof TrommelCoreBlock
        ...
        if (accessor.getBlock() instanceof TrommelCoreBlock
                || accessor.getBlock() instanceof TrommelDrumBlock) {
            tooltip.add(Component.translatable("jade.recompile.trommel_feed"));
        }
    }
