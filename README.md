...
**Alpha - released.** **v0.19.0** shipped 2026-09-05 to CurseForge and [GitHub Releases](https://github.com/Flatts3000/recompile/releases), built against MC `26.1.2` / NeoForge `26.1.2`. Recompile is the CurseForge ModJam 2026 ("Echoes of the Past") entry.
