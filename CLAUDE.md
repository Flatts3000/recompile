...
**None of this is built yet.** What it costs when it is: Idea Fragments and the fragment-to-Blueprint step go, and nine of the thirteen `recompile:teardown` recipes lose their `teaches` field and gain component outputs. Blueprints, the Filing Cabinet and the Scrap Crafting Table all survive. `docs/structural_analogs.md` carries the survey the ruling was made against.
